...
namespace Match3MakerTests {
    ...
    public class SequenceFinderTests {
        ...
        public void Should_Find_Horizontal_Matches_When_Enabled() {
            ...
            .Select(cell => {
                cell.AssignPiece(new Piece(_pieceFactory.CreateNormalPiece("square")));
                return cell;
            });
            ...
            Assert.True(sequences.First().Cells.All(cell => cell.Piece.Type.GetType().Equals(typeof(NormalPieceType)) && cell.Piece.Type.Shape.Equals("square")));
        }
        ...
        public void Should_Find_Horizontal_Matches_On_Min_Max_Match_Range_Order_Desc_By_Size() {
           ...
           .Select(cell => {
               cell.AssignPiece(new Piece(_pieceFactory.CreateNormalPiece("circle")));
               return cell;
           });
            ...
            Assert.True(sequences.First().Cells.All(cell => cell.Piece.Type.Shape.Equals("circle")));
            Assert.True(sequences.ToArray()[1].Cells.All(cell => cell.Piece.Type.Shape.Equals("square")));
        }
        ...
        .Select(cell => {
          ...
          .Select(cell => {
            ...
            Assert.True(sequences.First().Cells.All(cell => cell.Piece.Type.Shape.Equals("circle")));
            Assert.True(sequences.ToArray()[1].Cells.All(cell => cell.Piece.Type.Shape.Equals("circle")));
        }
        ...
        public void Should_Find_Vertical_Matches_When_Enabled() {
            ...
            Assert.Single(sequences);
            Assert.Equal(cells.Count(), sequences.First().Cells.Count);
            Assert.True(sequences.First().Cells.All(cell => cell.Piece.Type.Shape.Equals("square")));
        }
        ...
        public void Should_Find_TSHapes() {
            var horizontalCells = new List<GridCell>() {
                        ...
                        new(4, 3, new Piece(_pieceFactory.CreateNormalPiece("triangle"))),
                        new(5, 3, new Piece(_pieceFactory.CreateNormalPiece("square"))),
                        new(6, 3, new Piece(_pieceFactory.CreateNormalPiece("triangle"))),
                        new(7, 3, new Piece(_pieceFactory.CreateNormalPiece("triangle")))
                    };
            var verticalCells = new List<GridCell>() {
                new(5, 3, new Piece(_pieceFactory.CreateNormalPiece("square"))),
                new(5, 4, new Piece(_pieceFactory.CreateNormalPiece("square"))),
            ...
            verticalCells = [
                new(5, 3,
                new Piece(_pieceFactory.CreateNormalPiece("square"))),
                new(5, 2, new Piece(_pieceFactory.CreateNormalPiece("square"))),
                new(5, 1, new Piece(_pieceFactory.CreateNormalPiece("square")))
            ];
            ...
            horizontalCells = [
                new(5, 4, new Piece(_pieceFactory.CreateNormalPiece("circle"))),
                new(6, 4, new Piece(_pieceFactory.CreateNormalPiece("square"))),
                new(7, 4, new Piece(_pieceFactory.CreateNormalPiece("square")))
            ];

            verticalCells = [
                new(5, 2, new Piece(_pieceFactory.CreateNormalPiece("circle"))),
                new(5, 3, new Piece(_pieceFactory.CreateNormalPiece("circle"))),
                new(5, 4, new Piece(_pieceFactory.CreateNormalPiece("circle"))),
                new(5, 5, new Piece(_pieceFactory.CreateNormalPiece("circle"))),
                new(5, 6, new Piece(_pieceFactory.CreateNormalPiece("circle")))
            ];
            ...
            horizontalCells = [
                new(3, 4, new Piece(_pieceFactory.CreateNormalPiece("circle"))),
                new(4, 4, new Piece(_pieceFactory.CreateNormalPiece("circle"))),
                new(5, 4, new Piece(_pieceFactory.CreateNormalPiece("circle")))
            ];
        ...
        public void Should_Find_LSHapes() {
            var horizontalCells = new List<GridCell>() {
                        new(3, 3, new Piece(_pieceFactory.CreateNormalPiece("triangle"))),
                        new(4, 3, new Piece(_pieceFactory.CreateNormalPiece("square"))),
                        new(5, 3, new Piece(_pieceFactory.CreateNormalPiece("square"))),
                        new(6, 3, new Piece(_pieceFactory.CreateNormalPiece("circle"))),
                        new(7, 3, new Piece(_pieceFactory.CreateNormalPiece("square")))};

            var verticalCells = new List<GridCell>() {
                new(3, 3, new Piece(_pieceFactory.CreateNormalPiece("triangle"))),
                new(3, 4, new Piece(_pieceFactory.CreateNormalPiece("triangle"))),
            ...
            verticalCells = [
                new(3, 3, new Piece(_pieceFactory.CreateNormalPiece("triangle"))),
                new(3, 2, new Piece(_pieceFactory.CreateNormalPiece("triangle"))),
                new(3, 1, new Piece(_pieceFactory.CreateNormalPiece("triangle")))
            ];
            ...
            verticalCells = [
                new(7, 3, new Piece(_pieceFactory.CreateNormalPiece("triangle"))),
                new(7, 4, new Piece(_pieceFactory.CreateNormalPiece("triangle"))),
                new(7, 5, new Piece(_pieceFactory.CreateNormalPiece("triangle")))
            ];
            ...
            verticalCells = [
                new(7, 3, new Piece(_pieceFactory.CreateNormalPiece("triangle"))),
                new(7, 2, new Piece(_pieceFactory.CreateNormalPiece("triangle"))),
                new(7, 1, new Piece(_pieceFactory.CreateNormalPiece("triangle")))
            ];
